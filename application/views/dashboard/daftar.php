    ...
    <div class="site-wrap" id="home-section">
            ...
            <div class="col-9  text-right">
              ...
              <nav class="site-navigation text-right ml-auto d-none d-lg-block" role="navigation">
                <ul class="site-menu main-menu js-clone-nav ml-auto ">
                  ...
                  <li><a href="testimonials.html" class="nav-link">Daftar/Masuk</a></li>
      ...
      <form id="form12">
        <div class="form-group row" id="div1">
          <label for="user_name" class="col-4 col-form-label">username</label> 
          <div class="col-4">
            <input id="user_name" name="user_name" placeholder="masukkan" type="text" class="form-control">
          </div>
        </div>
        ...
        <label for="password" class="col-4 col-form-label">Email</label> 
          <div class="col-4">
